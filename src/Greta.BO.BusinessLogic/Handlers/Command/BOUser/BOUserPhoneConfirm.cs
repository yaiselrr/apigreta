...
{
    public class BOUserPhoneConfirm
    {
        ...
        public class Handler : IRequestHandler<Command, Response>
        {
            ...
            private readonly IRequestClient<UserPhoneConfirmRequestContract> _client;
            ...
            public Handler(
                ...
                IRequestClient<UserPhoneConfirmRequestContract> client,
            ...
            public async Task<Response> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                var result = await _client.GetResponse<Greta.Sdk.MassTransit.Contracts.BooleanResponseContract, FailResponseContract>(new
                {
                ...
                if (result.Is(out Response<FailResponseContract> response))
                {
                    ...
                    _logger.LogInformation($"User identity {request.Id} no found.");
                    throw new BusinessLogicException(((List<string>) response.Message.ErrorMessages)[0]);
                }

                _logger.LogInformation($"BOUser {request.Id} phone confirm successfully.");
