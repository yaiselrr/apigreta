...
{
    public class BOUserLockoutEnable
    {
        ...
        public class Handler : IRequestHandler<Command, Response>
        {
            ...
            private readonly IRequestClient<UserLockutEnableRequestContract> _client;
            ...
            public Handler(
                ...
                IRequestClient<UserLockutEnableRequestContract> client,
            ...
            public async Task<Response> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                _logger.LogInformation($"BOUser {request.Id} lockout enable successfully.");
