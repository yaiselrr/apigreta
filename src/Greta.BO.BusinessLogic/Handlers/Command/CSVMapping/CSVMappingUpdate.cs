...
{
    public static class CSVMappingUpdate
    {
        ...
        public class Validator : AbstractValidator<Command>
        {
            ...
            private async Task<bool> NameUnique(CSVMappingModel entity, CancellationToken cancellationToken)
            {
                var upcExist = await _service.GetByName(entity.Name);
                return upcExist == null || upcExist.Id == entity.Id;
            }
        ...
        public class Handler : IRequestHandler<Command, Response>
        {
            ...
            public async Task<Response> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                if (!errors.Any())
                {
                    ...
                    //creating mapping
                    var result = await _service.Put(mapping.Id, mapping);
                    _logger.LogInformation($"Update CSVMapping {mapping.Id}");
