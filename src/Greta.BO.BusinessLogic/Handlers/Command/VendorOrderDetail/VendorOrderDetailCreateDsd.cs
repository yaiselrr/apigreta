...
public record VendorOrderDetailCreateDsdCommand(VendorDetailListModel Entity) : IRequest<VendorOrderDetailCreateDsdResponse>,
    IAuthorizable
{
    /// <inheritdoc />
...
/// <inheritdoc />
public class VendorOrderDetailCreateDsdHandler : IRequestHandler<VendorOrderDetailCreateDsdCommand, VendorOrderDetailCreateDsdResponse>
{
    ...
    public VendorOrderDetailCreateDsdHandler(
    ...
    /// <inheritdoc />
    public async Task<VendorOrderDetailCreateDsdResponse> Handle(VendorOrderDetailCreateDsdCommand request,
        CancellationToken cancellationToken)
    {
        ...
        return new VendorOrderDetailCreateDsdResponse { Data = result };
    }
}

/// <inheritdoc />
public record VendorOrderDetailCreateDsdResponse : CQRSResponse<bool>;