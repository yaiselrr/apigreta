...
{
    public static class ProductFilterByBatch
    {
        public record Query(long batchId, int CurrentPage, int PageSize, ProductSearchModel Filter) : IRequest<Response>, IAuthorizable
        {
        ...
        public class Handler : IRequestHandler<Query, Response>
        {
            ...
            public async Task<Response> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                var entities = await _service.FilterByBatch(
                    request.batchId,
                    request.CurrentPage,
                    request.PageSize,
