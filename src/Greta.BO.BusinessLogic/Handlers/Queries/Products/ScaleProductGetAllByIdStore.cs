...
{
    public static class ScaleProductGetAllByIdStore
    {
        public record Query(long storeId) : IRequest<Response>, IAuthorizable
        {
        ...
        public class Handler : IRequestHandler<Query, Response>
        {
            ...
            {
                var entities = await _service.GetScaleProductById(request.storeId);

                return new Response { Data = _mapper.Map<List<ScaleProductModel>>(entities) };
            }
        }

        public record Response : CQRSResponse<List<ScaleProductModel>>;
    }
}