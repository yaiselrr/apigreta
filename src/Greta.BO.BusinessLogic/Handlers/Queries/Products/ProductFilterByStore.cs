...
{
    public static class ProductFilterByStore
    {
        public record Query(long store, int CurrentPage, int PageSize, ProductSearchModel Filter) : IRequest<Response>, IAuthorizable
        {
        ...
        public class Handler : IRequestHandler<Query, Response>
        {
            ...
            public async Task<Response> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                var entities = await _service.FilterByStore(
                    request.store,
                    request.CurrentPage,
                    request.PageSize,
