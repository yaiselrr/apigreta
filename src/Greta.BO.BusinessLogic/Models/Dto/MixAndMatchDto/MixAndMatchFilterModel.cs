...
public class MixAndMatchFilterModel : IDtoLong<string>, IMapFrom<MixAndMatch>
{
    [Required]
    ...
    /// </summary>
    public ProductByFilter ProductBuy { get; set; }

    public List<long> FamilyIds { get; set; }
    public List<long> ProductIds { get; set; }
    public List<FamilyModel> Families { get; set; }
    public List<ProductSingleFilterModel> Products { get; set; }
...
public class ProductByFilter : IMapFrom<Product>
{
...
public class ProductSingleFilterModel : IMapFrom<Product>
{
    [Required] public string UPC { get; set; }
