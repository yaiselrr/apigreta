...
namespace Greta.BO.Api.Sqlserver.EntityConfiguration
{
    public class ScaleProductEntityConfiguration : IEntityTypeConfiguration<ScaleProduct>
    {
        public void Configure(EntityTypeBuilder<ScaleProduct> builder)
        {
            ...
            builder.Property(x => x.Description1).HasColumnType("varchar(300)").IsRequired();
            builder.Property(x => x.Description2).HasColumnType("varchar(300)");
            builder.Property(x => x.Description3).HasColumnType("varchar(300)");

            builder.Property(x => x.Text1).HasColumnType("varchar(2000)");
            builder.Property(x => x.Text2).HasColumnType("varchar(2000)");
            builder.Property(x => x.Text3).HasColumnType("varchar(2000)");
            builder.Property(x => x.Text4).HasColumnType("varchar(2000)");

            builder.Property(x => x.Tare2).HasColumnType("numeric(18,2)");

            builder.Property(x => x.PackageWeight).HasColumnType("numeric(18,2)");


            builder.HasOne(x => x.ScaleCategory).WithMany().HasForeignKey(x => x.ScaleCategoryId)
