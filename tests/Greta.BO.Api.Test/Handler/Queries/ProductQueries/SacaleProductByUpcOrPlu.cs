...
public class SacaleProductByUpcOrPlu
{
    ...
    public SacaleProductByUpcOrPlu()
    {
        ...
        _handler = new ScaleProductGetByUpcOrPluHandler(            
            service,
    ...
    public async Task FilterSpec_NormalCall_ResultOk()
    {
        ...
        scaleProducts.Add(new ScaleProduct() { Id = 128, Name = "ScaleProduct128", UPC = "UPC128", Description1 = "Desc1" });
        scaleProducts.Add(new ScaleProduct() { Id = 129, Name = "ScaleProduct129", UPC = "UPC129", Description1 = "Desc2" });
        var scaleProductsCreated = await _repository.CreateRangeAsync(scaleProducts);
        await context.SaveChangesAsync();

        List<long> idsScaleProduct = new List<long>();
        idsScaleProduct.Add(129);
        ...
        var query = new ScaleProductGetByUpcOrPluQuery(filter);
        ...
        Assert.Equal(129, result.Data.First().Id);
    }
}