...
public class ReportShowReportFileEndpointTest
{
    readonly ReportRepository _repository;
    readonly ReportService _service;
    readonly ReportShowReportFile _endpoint;

    readonly Mock<IMediator> _mediatorMock;

    public ReportShowReportFileEndpointTest()
    {
        var builder = new DbContextOptionsBuilder<SqlServerContext>();
        var options = builder.UseInMemoryDatabase(nameof(ReportShowReportFileEndpointTest)).Options;
        ...
        _endpoint = new ReportShowReportFile(_mediatorMock.Object, Mock.Of<IConfiguration>());
    }
    ...
    public async Task ShowReport_WithSameId_ResultRedirectResult()
    {
        ...
        var request = new ReportShowReportFileRequest() { Id = (int)rep, Parameters = parameters, Token = token, Format = "csv", Inline = true };
    ...
    public async Task ShowReport_WithNotFoundId_ResultBadRequest()
    {
        ...
        var request = new ReportShowReportFileRequest() { Id = 8, Parameters = parameters, Token = token, Format = "csv", Inline = true };
